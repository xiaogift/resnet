#!/usr/bin/env python3
# ============================================================================== #
# ResNet-50(Pretrained) @ CIFAR-10
# Best Accuracy: 94.42%
# 32x32 -> crop -> flip -> 3x3 Conv1 -> 512relu -> 10fc
...
CONFIG ={ "architecture": "ResNet-50(Pre-trained)",
          "dataset": "CIFAR-10",
          "epochs": 100,
          "batch_size": BATCH_SIZE,
          "version": "0.3",
          "note": "32x32 -> crop -> flip -> 3x3 Conv1 -> 512relu -> 10fc" }
...
# ============================================================================== #
def get_data():
    basic = T.Compose([ T.ToTensor(),
                        T.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])
                        ])
    trans = T.Compose([ T.RandomCrop(32, padding=4),
                        T.RandomHorizontalFlip(p=0.5)
                        ] + [basic])
    train_dataset = CIFAR10(root=DATA_DIR, train=True, download=True, transform=trans)
...
class Simo:
    ...
    def __init__(self):
        self.wandb_run = wandb.init( project = "simo", name="resnet50_32_aug_3x3_relu", config = CONFIG) ###
    ...
    def transfer_learning(self):
        ...
        print(f'Start retrain RetNet-50 on device {DEVICE} ...')
